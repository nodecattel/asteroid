...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#general-api-information)    General API information
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#http-return-codes)    HTTP return codes
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#error-codes-and-messages)    Error codes and messages
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#general-information-on-endpoints)    General information on endpoints
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#limits)    Limits
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#ip-limits)    IP limits
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#order-rate-limits)    Order rate limits
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#endpoint-security-type)    Endpoint security type
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#signed-trade-and-user_data-endpoint-security)    SIGNED (TRADE and USER\_DATA) endpoint security
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#timing-security)    Timing security
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#signed-endpoint-examples-for-post-fapi-v1-order)    Signed endpoint examples for POST /fapi/v1/order
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#public-endpoints-info)    Public endpoints info

#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#terminology)    Terminology
...
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#enum-definitions)    ENUM definitions
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#filters)    Filters

Filters define trading rules on a symbol or an exchange.

#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#symbol-filters)    Symbol filters
...
## [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#market-data-endpoints)    Market data endpoints

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#test-connectivity)    Test connectivity
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined)

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#check-server-time)    Check Server Time
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-1)

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#exchange-information)    Exchange information
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-2)

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#order-book)    Order book
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#recent-trades-list)    Recent trades list
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-3)

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#old-trades-lookup-market_data)    Old trades lookup (MARKET\_DATA)
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-4)

### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#compressed-aggregate-trades-list)    Compressed/Aggregate trades list
...
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#kline-candlestick-data)    Kline/Candlestick data
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#index-price-kline-candlestick-data)    Index price kline/candlestick data\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#mark-price-kline-candlestick-data)    Mark Price Kline/Candlestick Data\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-5)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#mark-price)    Mark Price\
\
> **Response:**\
\
Copy\
...
NO\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#get-funding-rate-history)    Get funding rate history\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-6)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#id-24hr-ticker-price-change-statistics)    24hr ticker price change statistics\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#symbol-price-ticker)    Symbol price ticker\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#symbol-order-book-ticker)    Symbol order book ticker\
\
> **Response:**\
\
Copy\
...
\
\
## [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#websocket-market-streams)    WebSocket market streams\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#websocket-access)    WebSocket access\
\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#connection-rules-and-limits)    Connection rules and limits\
\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#recommendation)    Recommendation\
\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#live-subscribing-unsubscribing-to-streams)    Live subscribing/Unsubscribing to streams\
\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#subscribe-to-a-stream)    Subscribe to a stream\
\
> **Response**\
\
Copy\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#unsubscribe-to-a-stream)    Unsubscribe to a stream\
\
> **Response**\
\
Copy\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#listing-subscriptions)    Listing subscriptions\
\
> **Response**\
\
Copy\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#setting-properties)    Setting properties\
\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#retrieving-properties)    Retrieving properties\
\
> **Response**\
\
Copy\
...
\
\
#### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#error-messages)    Error messages\
\
Error Message\
\
Description\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#aggregate-trade-streams)    Aggregate trade streams\
\
> **Payload:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#mark-price-stream)    Mark price stream\
\
> **Payload:**\
\
Copy\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#mark-price-stream-for-all-markets)    Mark price stream for all markets\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 3000ms or 1000ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#kline-candlestick-streams)    Kline/candlestick streams\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 250ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#individual-symbol-mini-ticker-stream)    Individual symbol mini ticker stream\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 500ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#all-market-mini-tickers-stream)    All market mini tickers stream\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 1000ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#individual-symbol-ticker-streams)    Individual symbol ticker streams\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 500ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#all-market-tickers-streams)    All market tickers streams\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 1000ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#individual-symbol-book-ticker-streams)    Individual symbol book ticker streams\
\
> **Payload:**\
\
Copy\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#all-book-tickers-stream)    All book tickers stream\
\
> **Payload:**\
\
Copy\
...
**Update speed:** Real-time\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#liquidation-order-streams)    Liquidation order streams\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 1000ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#all-market-liquidation-order-streams)    All market liquidation order streams\
\
> **Payload:**\
\
Copy\
...
**Update speed:** 1000ms\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#partial-book-depth-streams)    Partial book depth streams\
\
> **Payload:**\
\
Copy\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#diff.-book-depth-streams)    Diff. book depth streams\
\
> **Payload:**\
\
Copy\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#how-to-manage-a-local-order-book-correctly)    How to manage a local order book correctly\
\
...
\
\
## [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#account-trades-endpoints)    Account/Trades endpoints\
\
Considering the possible data latency from RESTful endpoints during an extremely volatile market, it is highly recommended to get the order status, position, etc. from the WebSocket user data stream.\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#change-position-mode-trade)    Change position mode (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-7)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#get-current-position-mode-user_data)    Get current position mode (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-8)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#change-multi-assets-mode-trade)    Change Multi-Assets Mode (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-9)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#get-current-multi-assets-mode-user_data)    Get Current Multi-Assets Mode (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#undefined-10)\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#new-order-trade)    New order (TRADE)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#place-multiple-orders-trade)    Place Multiple Orders (TRADE)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#query-order-user_data)    Query Order (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#cancel-order-trade)    Cancel Order (TRADE)\
\
> **Response:**\
\
Copy\
...
Either `orderId` or `origClientOrderId` must be sent.\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#cancel-all-open-orders-trade)    Cancel All Open Orders (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#cancel-multiple-orders-trade)    Cancel Multiple Orders (TRADE)\
\
> **Response:**\
\
Copy\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#auto-cancel-all-open-orders-trade)    Auto-Cancel All Open Orders (TRADE)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#query-current-open-order-user_data)    Query Current Open Order (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#current-all-open-orders-user_data)    Current All Open Orders (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#all-orders-user_data)    All Orders (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#futures-account-balance-v2-user_data)    Futures Account Balance V2 (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#account-information-v4-user_data)    Account Information V4 (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#change-initial-leverage-trade)    Change Initial Leverage (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#change-margin-type-trade)    Change Margin Type (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#modify-isolated-position-margin-trade)    Modify Isolated Position Margin (TRADE)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#get-position-margin-change-history-trade)    Get Position Margin Change History (TRADE)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#position-information-v2-user_data)    Position Information V2 (USER\_DATA)\
\
> **Response:**\
\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#account-trade-list-user_data)    Account Trade List (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#get-income-history-user_data)    Get Income History(USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#notional-and-leverage-brackets-user_data)    Notional and Leverage Brackets (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#position-adl-quantile-estimation-user_data)    Position ADL Quantile Estimation (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#users-force-orders-user_data)    User's Force Orders (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#user-commission-rate-user_data)    User Commission Rate (USER\_DATA)\
\
> **Response:**\
\
Copy\
...
YES\
\
## [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#user-data-streams)    User Data Streams\
\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#start-user-data-stream-user_stream)    Start User Data Stream (USER\_STREAM)\
\
> **Response:**\
\
Copy\
...
None\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#keepalive-user-data-stream-user_stream)    Keepalive User Data Stream (USER\_STREAM)\
\
> **Response:**\
\
Copy\
...
None\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#close-user-data-stream-user_stream)    Close User Data Stream (USER\_STREAM)\
\
> **Response:**\
\
Copy\
...
None\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#event-user-data-stream-expired)    Event: User Data Stream Expired\
\
> **Payload:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#event-margin-call)    Event: Margin Call\
\
> **Payload:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#event-balance-and-position-update)    Event: Balance and Position Update\
\
> **Payload:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#event-order-update)    Event: Order Update\
\
> **Payload:**\
\
Copy\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#event-account-configuration-update-previous-leverage-update)    Event: Account Configuration Update previous Leverage Update\
\
> **Payload:**\
\
Copy\
...
\
## [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#error-codes)    Error Codes\
\
...
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#id-10xx-general-server-or-network-issues)    10xx - General Server or Network issues\
\
> -1000 UNKNOWN\
\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#id-11xx-request-issues)    11xx - Request issues\
\
> -1100 ILLEGAL\_CHARS\
\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#id-20xx-processing-issues)    20xx - Processing Issues\
\
...
\
\
### [Direct link to heading](https://docs.asterdex.com/product/aster-perpetual-pro/api/api-documentation\#id-40xx-filters-and-other-issues)    40xx - Filters and other Issues\
\
...
\
\
[PreviousHow to create an API](https://docs.asterdex.com/product/aster-perpetual-pro/api/how-to-create-an-api) [Next1001x (Simple)](https://docs.asterdex.com/product/1001x-simple)\
\
